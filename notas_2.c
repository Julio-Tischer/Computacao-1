...
int main(){
    ...
    if (Frequencia>= 75 && Media>8.0){
        ...
        printf("\n\n Parabens! Você foi aprovado com DISTINÇÃO. Sua media é %.1f e sua frequencia foi %d%%",Media,Frequencia);
    }
    else if (Media>=6 && Frequencia >= 75){

        printf("\n\n Parabens, você esta aprovado. Sua media é %.1f e sua frequencia foi %d%%",Media,Frequencia);
    }
        ...
        printf("\n\n Melhor se esforçar, você esta em exame com media %.1f e frequencia %d%%",Media,Frequencia);
    }
    else if (Media<4 || Frequencia<=50){

        printf("\n\n Você esta reprovado, pois sua nota e/ou frequencia foram muito baixas. Sua media foi de %.1f e frequencia foi de %d%%",Media,Frequencia);
    }
    else{
